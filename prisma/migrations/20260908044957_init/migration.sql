-- CreateEnum
CREATE TYPE "SpaceType" AS ENUM ('personal', 'company', 'client');
...
-- CreateIndex
CREATE INDEX "vault_entries_spaceId_idx" ON "vault_entries"("spaceId");
...
-- AddForeignKey
ALTER TABLE "vault_entries" ADD CONSTRAINT "vault_entries_spaceId_fkey" FOREIGN KEY ("spaceId") REFERENCES "spaces"("id") ON DELETE CASCADE ON UPDATE CASCADE;
